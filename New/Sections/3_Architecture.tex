...
(DMP)}~\cite{wu2023daydreamer} combined with \textit{Human-Robot Collaboration 
(HRC)}~\cite{andrychowicz2017hindsight}. Demonstrated trajectories are encoded as DMPs and stored in a library for future reuse, allowing continual expansion of manipulation skills.
